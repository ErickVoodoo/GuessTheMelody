...
import GameMusic from '../../static/music/game.mp3';
...
class Music extends EventEmitter {
  ...
  onApproximateVolume() {
    ...
    let changeConstant = getVolume /
        (Constants.APP_SETTINGS.MUSIC_STOP_SPEED / Constants.APP_SETTINGS.MUSIC_VOLUME_CHANGE_SPEED);
    let allMSeconds = 0;
